    ...
    <PaymentProviderContextProvider value={provider}>
      ...
      >
        <PaymentFormContent
          ...
          oldPaidPaymentMethodId={oldPaidPaymentMethodId}
          handlers={handlers}
        />
      </Elements>
...
export function PaidPaymentSetupPage({
  ...
  return (
    <div className={`flex flex-col w-full max-w-md py-24 mx-auto stretch`}>
      ...
      <PaymentSetupForm
        key={formKey} // Force remount to avoid payment element returning same confirmation token
        customerID={customerID}
        provider={provider}
